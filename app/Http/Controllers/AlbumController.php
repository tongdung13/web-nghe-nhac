...
class AlbumController extends Controller
{
    ...
    public function store(AlbumRequest $request)
    {
        ...
        return redirect()->route('albums.index')->with('message', 'Thêm dữ liệu thành công');
    }
    ...
    public function update(AlbumRequest $request, $id)
    {
        ...
        return redirect()->route('albums.index')->with('message', 'Cập nhập dữ lỉệu thành công.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('albums.index')->with('error', 'Xóa dữ liệu thành công');
    }
