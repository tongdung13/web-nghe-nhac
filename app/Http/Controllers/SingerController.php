...
class SingerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('singer.index')->with('message', 'Thêm dữ liệu thành công');
    }
    ...
    public function update(SingerRequest $request, $id)
    {
        ...
        $singer->save();
        Session::flash('success', 'Upload with success');
        return redirect()->route('singer.index')->with('message', 'Cập nhập dữ liệu thành công ');
    }
    ...
    public function destroy($id)
    {
        $singer = Singer::findOrFail($id);
        $singer->delete();
        return redirect()->route('singer.index')->with('error', 'Xóa dữ liệu thành công');
    }

    public function search(SingerRequest $request)
    {
        ...
        return view('singer.listSinger', compact('playlists', 'country', 'album', 'singers'));
