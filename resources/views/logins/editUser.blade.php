    ...
    <div class="container">
        <form method="POST" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                ...
                <select name="level">
                    <option @if ($user->level == 'SupAdmin') selected @endif>
                        SupAdmin</option>
                    <option @if ($user->level == 'User') selected @endif>User
                    </option>
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">level</span>
                <input disabled type="text" name="level" value="{{ $user->created_at }}" class="form-control"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">level</span>
                <input disabled type="text" name="level" value="{{ $user->updated_at }}" class="form-control"
                    aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
            </div>
